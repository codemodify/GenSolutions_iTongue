...
/*
    ...
    CGFloat widthFactor  = width  / image.size.width;
    CGFloat heightFactor = height / image.size.height;

    scaleFactor = ( widthFactor > heightFactor ) ? widthFactor : heightFactor;
    
    UIImage* newImage = [[UIImage alloc] initWithCGImage:image.CGImage scale:scaleFactor orientation:UIImageOrientationUp];
