...
- (void)delayedSettings{
    ...
    NSString* GenSoltions_GiftPicker_ApplicationID      = @"181045931928619";
    NSString* GenSoltions_GiftPicker_ApiKey             = @"6a4b12f54394ef421acd5dc86c2d7bc2";
    NSString* GenSoltions_GiftPicker_ApplicationSecret  = @"77cc118583814f947ff24f55c8cca88c";
