...
- (void)delayedSettings{
    ...
    NSString* GenSoltions_GiftPicker_ApplicationID      = @"121789024556640";
    NSString* GenSoltions_GiftPicker_ApiKey             = @"0f6842896a06530e8cbfbdd865899b06";
    NSString* GenSoltions_GiftPicker_ApplicationSecret  = @"0f41904f50abcdf53fd8a18b30e99363";
