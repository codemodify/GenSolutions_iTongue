...
-(void) viewDidLoad {
    position1 = overlayTopLeft.frame;
    position2 = overlayTopRight.frame;
    position3 = overlayBottomLeft.frame;
    position4 = overlayBottomRight.frame;
...
-(IBAction) cancel:(id)sender {
    ...
    overlayTopLeft.frame = position1;
    overlayTopRight.frame = position2;
    overlayBottomLeft.frame = position3;
    overlayBottomRight.frame = position4;
